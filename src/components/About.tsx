          ...
          <div className="relative z-10">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-5">
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 sm:p-6 border border-white/10 hover:bg-white/15 transition-colors group">
                <div className="text-2xl sm:text-4xl font-bold mb-1 sm:mb-2 text-[#06d6a0] group-hover:scale-110 transition-transform">30+</div>
                <div className="text-white/70 text-xs sm:text-sm">Years of Experience</div>
              </div>
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 sm:p-6 border border-white/10 hover:bg-white/15 transition-colors group">
                <div className="text-2xl sm:text-4xl font-bold mb-1 sm:mb-2 text-[#06d6a0] group-hover:scale-110 transition-transform">300+</div>
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 sm:p-6 border border-white/10 hover:bg-white/15 transition-colors group">
                <div className="text-2xl sm:text-4xl font-bold mb-1 sm:mb-2 text-[#06d6a0] group-hover:scale-110 transition-transform">24/7</div>
