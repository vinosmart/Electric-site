      ...
      <div className="relative z-10 px-4 mx-auto max-w-[1440px] sm:px-6 lg:px-8">
        <div ref={titleRef} className="mb-8 text-center sm:mb-10">
          ...
          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-3 sm:mb-4 text-[#154D71]">
            Power Infrastructure <span className='text-[#33A1E0]'>
              Excellence
            </span>
          </h2>
        ...
        <div className="grid items-start gap-6 mb-6 overflow-hidden lg:grid-cols-2 sm:gap-8">
          <div ref={contentLeftRef} className="space-y-4 sm:space-y-6">
            <div className="relative overflow-hidden shadow-2xl rounded-xl ring-4 ring-white">
              ...
              />
              <div className="absolute inset-0 bg-[#154D71]/60"></div>
            ...
            <div>
              <h3 className="text-xl sm:text-2xl font-bold mb-2 sm:mb-3 text-[#154D71]">Our Heritage</h3>
              <p className="text-[#64748B] leading-relaxed mb-3 sm:mb-4 text-sm sm:text-base">
                With <strong className="text-[#154D71]">30 years of proven expertise</strong>, MASS POWER SOLUTIONS has 
              ...
              <p className="text-[#64748B] leading-relaxed mb-3 sm:mb-4 text-sm sm:text-base">
                As a <strong className="text-[#154D71]">TNEB certified Class I contractor</strong> and <strong className="text-[#154D71]">ESA Grade License 
            ...
            <div>
              <h4 className="font-bold text-base sm:text-lg mb-3 sm:mb-4 text-[#154D71]">Core Competencies</h4>
          ...
          <div ref={contentRightRef} className="grid w-full gap-4 sm:gap-5" style={{ opacity: 1 }}>
            {valuePropositions.map((item, index) => (
              <Card
                key={item.title}
                className={`p-3 sm:p-4 md:p-6 hover:shadow-xl transition-all duration-500 hover:-translate-y-1 border-0 ${item.color}  group w-full`}
                style={{ opacity: 1 }}
              >
                <div className="flex items-start w-full gap-2 sm:gap-3">
                  <div className="flex items-center justify-center flex-shrink-0 w-8 h-8 transition-transform rounded-lg sm:w-10 sm:h-10 md:w-12 md:h-12 bg-white/15 group-hover:scale-110">
                    <item.icon size={16} className={`${item.text}  sm:hidden`} weight="duotone" />
                    <item.icon size={22} className={`hidden ${item.text}  sm:block md:hidden`} weight="duotone" />
                    <item.icon size={24} className={`hidden ${item.text}  md:block`} weight="duotone" />
                  </div>
                  <div className="flex-1 min-w-0">
                    <h4 className={`font-bold text-sm sm:text-base md:text-lg ${item.text}  mb-0.5 sm:mb-1`}>{item.title}</h4>
                    <p className={`text-xs leading-relaxed ${item.text} /80 sm:text-sm`}>{item.description}</p>
                  </div>
                </div>
              </Card>
            ))}
        ...
        <div ref={ctaRef} className="bg-[#33A1E0] rounded-2xl p-5 sm:p-8 lg:p-12 text-center text-white relative overflow-hidden shadow-2xl">
          ...
          <div className="relative z-10">
            <h3 className="mb-3 text-xl font-bold sm:text-2xl lg:text-3xl sm:mb-4">
            ...
            <div className="grid grid-cols-2 gap-3 sm:grid-cols-4 sm:gap-5">
              <div className="p-4 transition-colors border bg-white/10 backdrop-blur-sm rounded-xl sm:p-6 border-white/10 hover:bg-white/15 group">
                <div className="text-2xl sm:text-4xl font-bold mb-1 sm:mb-2 text-[#FFF9AF]/70 font-bold group-hover:scale-110 transition-transform">30+</div>
                <div className="text-xs text-white/70 sm:text-sm">Years of Experience</div>
              </div>
              <div className="p-4 transition-colors border bg-white/10 backdrop-blur-sm rounded-xl sm:p-6 border-white/10 hover:bg-white/15 group">
                <div className="text-2xl sm:text-4xl font-bold mb-1 sm:mb-2 text-[#FFF9AF]/70 font-bold group-hover:scale-110 transition-transform">300+</div>
                <div className="text-xs text-white/70 sm:text-sm">Skilled Professionals</div>
              </div>
              <div className="p-4 transition-colors border bg-white/10 backdrop-blur-sm rounded-xl sm:p-6 border-white/10 hover:bg-white/15 group">
                <div className="text-2xl sm:text-4xl font-bold mb-1 sm:mb-2 text-[#FFF9AF]/70 font-bold group-hover:scale-110 transition-transform">100%</div>
                <div className="text-xs text-white/70 sm:text-sm">Quality Compliance</div>
              </div>
              <div className="p-4 transition-colors border bg-white/10 backdrop-blur-sm rounded-xl sm:p-6 border-white/10 hover:bg-white/15 group">
                <div className="text-2xl sm:text-4xl font-bold mb-1 sm:mb-2 text-[#FFF9AF]/70 font-bold group-hover:scale-110 transition-transform">24/7</div>
